今までの活動、何かしら活動の記録をかいておいた方が良いかなあ、と思ってここにまとめる。
...
『I'm In The Computer Memory』INSTRUMENTAでの展示風景  
...
![](scr3.png)  
アプリケーションのスクリーンショット。左上の「さふぁり」ボタンを押すと、WindowsアプリでありながらMacOSのSafariを起動できる。また「えんとろぴい」ボタンでMacOS内臓乱数生成機能を使用することができる。
...
「NASA Space Apps Challenge」<https://github.com/aidatorajiro/MarCoin>
